...
function createScene() {
    ...
    particlesSprites.forEach((particleSprite) => {
        ...
        geometry.vertices.push(particleSprite.position);
    });
...
function createParticleSprites(spriteMaterial) {
    const result = [];
    for (let i = 0; i < 150; i++) {
...
function createParticleSprite(material) {
...
function createComposer(camera, scene, renderer) {
